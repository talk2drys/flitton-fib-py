...
setup(
        ...
        author_email="daniel.temiagin@gmail.com",
        description="Calculate a Fibonacci number", long_description=long_description,
        ...
        entry_points = {
            'console_scripts': ['fib-number = flitton_fib_py.cmd.fib_num:fib_numb'],
            },
        )
